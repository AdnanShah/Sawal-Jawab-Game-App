          ...
          <main className="app-main-content-wrapper">
            <div className="app-main-content">
              <Switch>
                ...
                <Route
                  path={`${match.url}/quizquestions`}
                  component={QuizQuestions}
                />
                <Route
                  path={`${match.url}/createquiz`}
                  component={CreateQuiz}
                />
                <Route path={`${match.url}/quizlist`} component={QuizList} />
                <Route
                  path={`${match.url}/createquestions`}
                  component={CreateQuestions}
                />
                <Route
                  path={`${match.url}/questionslist`}
